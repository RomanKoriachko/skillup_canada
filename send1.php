...
$manager_id = 4; //ідентифікатор відповідального менеджера
$source_id = 2; // ідентифікатор джерела
$title = '[С сайта LP Канада] '.$_POST['name']; // назва заявки
...
header('Location: https://skillupforua.com/lp/quality_assurance_canada/thankyou/');
